...
import { Checkbox, ConfigProvider, Layout, Menu } from 'antd'
      ...
      <ConfigProvider locale={ptBR}>
        <Router>
          <Layout style={{ minHeight: '100vh' }}>
            ...
            <div className="theme-background" style={{
              ...
              <Checkbox checked={theme === 'dark'} onChange={() => {
                if (theme === 'dark') {
                  setTheme('light')
                  saveTheme('light')
                } else {
            ...
            <Content className="main-content">
              <Switch>
                ...
                {adminOnly(<Route path='/perfil/:id/comentarios' exact
                                  render={(props) => <ProfileComments {...props}/>}>
                </Route>)}
